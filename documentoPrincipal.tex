...
%Escolher umAutor, doisAutores ou tresAutores
\setboolean{umAutor}{true}  
%\setboolean{doisAutores}{false}  
%\setboolean{tresAutores}{false}    
...
\subtitulo{Desenvolvimento de uma infra-estrutura integrada para geração de geração e controle de Orçamentos e Ordens de Serviços para centros automotivos}
...
%\coorientadoraR{Andrade, K. A. F.}

%-------------------------------------------------- INSTITUIÇÃO E PROGRAMA %
\universidade{FACULDADE SENAI FATESG} % {Universidade Federal de Goiás}
%\uni{FATESG}
\unidade{PÓS GRADUAÇÃO EM PROJETO E DESENVOLVIMENTO DE SOFTWARE PARA DISPOSITIVOS MÓVEIS E INTERNET} %Instituto
%\departamento{\textless Nome do Departamento\textgreater} %Unidades com mais de um depto.
   

%\universidadeco{FACULDADE SENAI}
%\unico{FATESG}
%\unidadeco{PÓS GRADUAÇÃO EM PROJETO E DESENVOLVIMENTO DE SOFTWARE PARA
%DISPOSITIVOS MÓVEIS E INTERNET}   
      
\programa{Projeto e Desenvolvimento de Software para Dispositivos Móveis e Internet} 
