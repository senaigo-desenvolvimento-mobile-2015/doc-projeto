...
\titulo{Pré-projeto WebOS}
%--------------Para incluir subtitulo do Trabalho---------%
\subtitulo{Suite de sistemas para centros automotivos para gerenciamento de orçamentos e ordem de serviço}
  
\cidade{Goiânia} % Nome da cidade 
\dia{24} % Dia da apresentação / defesa do trabalho
