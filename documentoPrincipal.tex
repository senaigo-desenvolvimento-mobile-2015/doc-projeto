...
\subtitulo{Site para gerenciamento de Ordem de Serviço}
...
%\uni{FATESG}
\unidade{PÓS GRADUAÇÃO EM PROJETO E DESENVOLVIMENTO DE SOFTWARE PARA
DISPOSITIVOS MÓVEIS E INTERNET} %Instituto
