...
Este documento define a modelagem do sistema prevendo uma visão da documentação do sistema \nomeTrabalho que poderá ser utilizado pela equipe de desenvolvimento para documentar os requisitos, modelos, tecnologias e arquitetura utilizadas no projeto do sistema. 
...
\begin{figure}[tb]
	\centering
	\includegraphics[width=7cm]{imagens/listagemProgramasPart1.png} \quad
	\includegraphics[width=7cm]{imagens/listagemProgramasPart2.png}
