...
\item Melhorias na usabilidade do cliente web e cliente mobile de acordo com o retorno dos usuários;
\item Implementação de grupos de acesso com diferentes perfis;
\item Integração com software de controle de estoque de produtos;
\item Integração com software de controle financeiro;
\item Melhorias na segurança do projeto habilitando ssl para as plataformas;
\end{enumerate} 